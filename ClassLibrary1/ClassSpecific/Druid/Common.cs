			...
			return new PrioritySelector(
				...
				new Decorator(
					...
					new PrioritySelector(
                        ...
                        // disable common barkskin if you are guardian druid, otherwise Guardian setting is ignored.
                        Spell.BuffSelf("Barkskin", ret => Me.HealthPercent < DruidSettings.Barkskin && Me.Specialization != WoWSpec.DruidGuardian),
