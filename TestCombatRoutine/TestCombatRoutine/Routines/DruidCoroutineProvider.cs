...
{
    public class DruidCoroutineProvider : BaseCoroutineProvider
    {
        private static DruidCoroutineProvider instance;

        private DruidCoroutineProvider() { }

        public static DruidCoroutineProvider Instance => instance ?? (instance = new DruidCoroutineProvider());
